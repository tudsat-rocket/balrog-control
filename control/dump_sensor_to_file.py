...
def dump_sensor_to_file():
    ...
    writer.writerow(["Time (periode)", "Pressure 2", "Pressure 3", "Pressure 4", "Temperatur Nitrous",
                          "Temperatur Engine", "Thrust load cell", "Nitrous load cell", "Differential Nitrous pressure"])
    time = 0
